...
$zile_saptamana = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
    ...
    <?php
            ...
            <div class="row mb-4 navig_agenda">
                <div class="col-md-3">
                    ...
                    <a href="?view=week&week_start=<?php echo date('Y-m-d', strtotime('monday this week')); ?>" class="btn btn-primary">Today</a>
                </div>
                <div class="col-md-6">
                    ...
                    foreach ($days_of_week as $date) {
                        if (isset($days_with_events[$date])) {
                            ...
                            foreach ($days_with_events[$date] as $event) {
                                ...
                                echo htmlspecialchars($event["text_en"]) . '</li>';
                            }
                            echo "</ul>";
                        }
                    }
